...
export const emailInput = el('div.d-flex.flex-column.mb-1.col-8.min-height', [
    el('label.form-label.fs-5.fst-italic', {
...
export const submitButton = el(
    'button.col-3.btn.btn-dark.btn-lg.me-3',
    {
        type: 'submit',
        id: 'submit-button',
    },
...
export const createCardTypeIconsBox = () => {
    const cardTypeIconsBox = el('div.d-flex' + '.col-3.align-items-center')
...
const createForm = () => {
    return el(
        ...
        [
            cardNumberInput,
            el(
                'div.d-flex.align-items-start.row.col-12.min-height',
                expirationInput,
                cvcInput
            ),
            emailInput,
            el(
                'div.d-flex.mb-3.col-10',
                submitButton,
                createCardTypeIconsBox()
            ),
        ]
    )
}
